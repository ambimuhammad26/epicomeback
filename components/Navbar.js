...
export default function Navbar() {
	...
	const dropdownList = [
		{ text: 'Internet', href: '/details' },
		{ text: 'Books', href: '/details' },
		{ text: 'Open Source', href: '/details' },
	];
    return (
        <nav className="py-10">
            <Container>
                <div className="flex items-center">
                    ...
                    <div className={`lg:w-7/12 w-full bg-gradient-to-b from-gray-600 to-gray-900 lg:bg-none fixed lg:static top-0 h-full p-10 lg:h-auto lg:p-0 transition-all ${offcanvas ? 'left-0' : '-left-full'}`}>
                        <button 
                    ...
                    <div className={`lg:w-3/12 absolute lg:static w-full left-0 px-10 lg:px-0 transition-all ${search ? 'top-10' : '-top-40'}`}>
                        ...
                        <input className="bg-gray-700 py-3 px-6 w-full lg:rounded-full rounded-lg outline-none bg-search pl-12" placeholder="Search ..." />
                    </div>
                </div>
            </Container>
        </nav>
